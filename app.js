...
var visualRecognition = new watson.VisualRecognitionV3({
  api_key: '46c3dd2bac70f98b55a7fab9b7f263ef627a77ce',
...
//app.get('/api/favorites/attach', api.getAttach);
//
//app.post('/api/favorites/attach', multipartMiddleware, api.postAttach);
//
//app.post('/api/favorites', api.postDoc);
//
//app.delete('/api/favorites', api.deleteDoc);
//
//app.put('/api/favorites', api.putDoc);
//
//app.get('/api/favorites', api.getDoc);
